...
# Load the model
model = tf.keras.models.load_model('all.keras')
...
while True:
    ...
    # Change this to match your model's input dimensions, e.g., (224, 224) if using a common architecture like ResNet50
    image = image.resize((224, 224))  # Adjust size according to model's input shape
